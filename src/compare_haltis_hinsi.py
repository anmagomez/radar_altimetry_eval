...
def load_insi_volformat(finsi):
    '''
    Load in situ elevation time series in Volodia format
    '''
    (indecy, inh) = np.genfromtxt(finsi, skip_header=1, unpack=True)
    return (indecy, inh)


def load_altis(falti, ncoldate, ncolh, ncolgeoid, nodataalti=-9999):
    '''
    ...
    - ncolgeoid: name of the column with geoid elevation time series
